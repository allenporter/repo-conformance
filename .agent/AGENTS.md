...
4. **Concurrency & Batching**: To prevent resource and context overload, **NEVER spawn more than 3 subagents concurrently**. Process larger sets of repositories in sequential batches of at most 3 subagents at a time.
